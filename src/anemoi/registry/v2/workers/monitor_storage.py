...
class MonitorStorageWorker(Worker):
    """Worker that reports quota/storage usage for the local site."""
    ...
    def worker_process_task(self, task):
        ...
        SiteCatalogueEntry(name="local").report_storage(dry_run=self.dry_run)
